...
MultiFolderView::MultiFolderView(Application *app, QWidget *parent)
...
void MultiFolderView::setChildRole(const QModelIndex &index, int role, const QVariant &value)
{
    m_model->setChildRole(index,role,value);
}
