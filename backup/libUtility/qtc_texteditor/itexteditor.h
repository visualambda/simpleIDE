...
class TEXTEDITOR_EXPORT ITextMark : public    IEditorMarkNode
{
    Q_OBJECT
public:
    ITextMark(QObject *parent = 0) :    IEditorMarkNode(parent), m_blockNumber(-1), m_type(-1), m_indexOfType(0) {}
    virtual ~ITextMark() {}
...
class TEXTEDITOR_EXPORT ITextEditorEx : public QObject//Core::IEditor
{
    Q_OBJECT
public:
...
signals:
    ...
    void markRequested(TextEditor::ITextEditorEx *editor, int line);
    void markContextMenuRequested(TextEditor::ITextEditorEx *editor, int line, QMenu *menu);
    void tooltipOverrideRequested(TextEditor::ITextEditorEx *editor, const QPoint &globalPos, int position, bool *handled);
    void tooltipRequested(TextEditor::ITextEditorEx *editor, const QPoint &globalPos, int position);
    void contextHelpIdRequested(TextEditor::ITextEditorEx *editor, int position);
};
