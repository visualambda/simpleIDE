...
struct FileUtil
{
    ...
    static QString lookupGoBin(const QString &bin,    IApplication *app, const QProcessEnvironment env, bool bLiteAppPriority);
    static QString lookupLiteBin(const QString &bin,    IApplication *app, const QProcessEnvironment env);
