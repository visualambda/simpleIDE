...
public:
    ...
    virtual QList<IEditorMark*> editorMarkList() const = 0;
signals:
    void editorMarkCreated(IEditorMark *mark);
    void editorMarkRemoved(IEditorMark *mark);
    void editorMarkListChanged(IEditorMark *mark, int type);
    void editorMarkNodeCreated(IEditorMark *mark, IEditorMarkNode *node);
    void editorMarkNodeRemoved(IEditorMark *mark, IEditorMarkNode *node);
    void editorMarkNodeChanged(IEditorMark *mark, IEditorMarkNode *node);
};
...
inline IHighlighterManager *getHighlighterManager(IApplication *app)
{
