...
LiteEditorFile::LiteEditorFile(IApplication *app, QObject *parent)
    : IFile(parent),
      m_liteApp(app)
{
...
//        return false;
    ...
    if (bCheckCodec) {
        ...
        if (mimeType == "text/html" || mimeType == "text/xml") {
            ...
            IMimeType *im = m_liteApp->mimeTypeManager()->findMimeType(mimeType);
            if (im) {
...
*/
    ...
    */
    ...
    if (noprintCheck && !mimeIsText(mimeType)) {
