...
void LiteEditorWidget::setCompleter(  ICompleter *completer)
{
...
void LiteEditorWidget::codeCompleter()
{
    ...
    if (isInImport) {
        ...
        m_completer->setCompletionContext(  CompleterImportContext);
        ...
        m_completer->setCompletionContext(  CompleterCodeContext);
        m_completer->setCompletionPrefix("");
